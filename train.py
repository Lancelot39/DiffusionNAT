...
os.environ["WANDB_API_KEY"] = "129fae65f6593a55df4361de3a8f435dcf11d23d"
...
def main():
    ...
    '''
    logger.log(f'### Load model parameter from {args.model_ckpt}')
    model.load_state_dict(
        dist_util.load_state_dict(args.model_ckpt, map_location="cpu")
    )
    '''
    ...
    if ('LOCAL_RANK' not in os.environ) or (int(os.environ['LOCAL_RANK']) == 0):
        wandb.init(
            project=os.getenv("WANDB_PROJECT", "Diffusion-NAT"),
